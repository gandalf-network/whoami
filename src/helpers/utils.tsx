...
export const appInfo = {
  ...
  connectUrl: `https://auth.gandalf.network/?data=eyJuZXRmbGl4Ijp7InRyYWl0cyI6WyJwbGFuIl19fQ==&publicKey=${process.env.NEXT_PUBLIC_GANDALF_PUBLIC_KEY}&redirectUrl=${process.env.NEXT_PUBLIC_VERCEL_URL}`,
};
