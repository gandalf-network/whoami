...
export type ActivityMetadata = {
  ...
  subject?: Maybe<Maybe<Identifier>[]>;
};
...
export type LookupActivityQuery = {
  __typename: "Query";
  lookupActivity: {
    __typename: "Activity";
    id: string;
...
export default class Eye {
  ...
  async getActivity(
    ...
    try {
      const { data } = await this.withWrapper(
        (wrappedRequestHeaders) =>
          this.client.rawRequest<GetActivityQuery>(
            GetActivityDocumentString,
            variables,
  ...
  async lookupActivity(
    variables: LookupActivityQueryVariables,
    requestHeaders?: GraphQLClientRequestHeaders,
  ) {
    const requestBody = {
    ...
    try {
      const { data } = await this.withWrapper(
        (wrappedRequestHeaders) =>
          this.client.rawRequest<LookupActivityQuery>(
            LookupActivityDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "lookupActivity",
  ...
  async getAppByPublicKey(
    ...
    try {
      const { data } = await this.withWrapper(
        (wrappedRequestHeaders) =>
          this.client.rawRequest<GetAppByPublicKeyQuery>(
            GetAppByPublicKeyDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getAppByPublicKey",
