        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "BFF": {
                        "type": "string",
                        "description": "A BFF based on the character's personality and the user's top genres. It should be just the name of the character, nothing else."
                    },
                    "BFFQuip": {
                        "type": "string",
                        "description": "A witty quip about the BFF you assigned to the user. The focus should be on why they're perfect for each other. Max 140 characters."
                    }
                },
                "required": [
                    "BFF",
