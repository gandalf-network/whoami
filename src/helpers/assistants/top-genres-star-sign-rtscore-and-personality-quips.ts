        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "RTScoreQuip": {
                        "type": "string",
                        "description": "A remark focused only on the user's Rotten Tomatoes score. It will only refer to the user's RT Score. Either it makes the user feel good about their high score or it reassures about their low/average score. It will not include the score itself. It will not include the words 'Rotten Tomatoes' or 'RT'. Must be succinct. Max 140 characters."
                    },
                    "personality": {
                        "type": "string",
                    ...
                    "personalityQuip": {
                        "type": "string",
                        "description": "A witty quip about the personality you assigned to the user. It will not include the names of the shows. Max 140 characters."
                    }
                },
                "required": [
                    "topGenresQuip",
