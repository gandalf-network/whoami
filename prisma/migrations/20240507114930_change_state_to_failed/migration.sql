/*
  ...
  - The values [INTERNAL_SERVER_ERROR] on the enum `UserState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "UserState_new" AS ENUM ('AWAITING_CONNECTION', 'CONNECTED', 'FAILED', 'CRUNCHING_DATA', 'STATS_DATA_READY', 'COMPLETED');
